            ...
            <div className="container mx-auto px-4">
                ...
                <div className="hidden lg:block mb-8">
                    <div className="grid grid-cols-5 gap-8">
                        ...
                        <div className="space-y-4">
                            <h4 className="text-lg font-semibold text-navy text-center">Contact Info</h4>
                        ...
                        {/* Column 3: Policies */}
                        <div className="space-y-4">
                            <h4 className="text-lg font-semibold text-navy text-center">Policies</h4>
                        ...
                        <div className="space-y-4">
                            <h4 className="text-lg font-semibold text-navy text-center">Projects by EMC</h4>
                            <div className="space-y-2 text-sm text-center">
                                <a href="/emc" className="text-navy hover:text-accent transition-colors duration-300 block">EMC</a>
                                <a href="/consulting" className="text-navy hover:text-accent transition-colors duration-300 block">Consulting</a>
                                <a href="/after-sales" className="text-navy hover:text-accent transition-colors duration-300 block">After Sales</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    ...
                    <div className="flex space-x-4">
                        ...
                        >
                            ...
                            <Facebook size={24} className="relative z-10 text-navy group-hover:text-white transition-colors duration-300" />
                        </a>
                        <a
                        ...
                        >
                            <div className="absolute inset-0 bg-navy rounded-full scale-0 group-hover:scale-100 transition-transform duration-300 ease-out"></div>
                            <Linkedin size={24} className="relative z-10 text-navy group-hover:text-white transition-colors duration-300" />
                        </a>
                        <a
                        ...
                        >
                            <div className="absolute inset-0 bg-navy rounded-full scale-0 group-hover:scale-100 transition-transform duration-300 ease-out"></div>
                            <Instagram size={24} className="relative z-10 text-navy group-hover:text-white transition-colors duration-300" />
                        </a>
                    </div>
                    {/* Production Info - Center */}
                    <div className="text-sm text-gray-700 text-center">
                        <a href="https://www.instagram.com/softsolutions.eg/?utm_source=ig_web_button_share_sheet" target="_blank" rel="noopener noreferrer" className="text-navy hover:text-accent transition-colors duration-300">
